    ...
    <div id="meat-sector-view" className="bg-[#FAF9F5] min-h-screen text-emerald-950 pt-24 font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <div className="relative py-28 overflow-hidden border-b border-emerald-900/10">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1500595046743-cd271d694d30?q=80&w=1600')` }}
        />
          ...
          >
            ...
            <div className="p-8 bg-white border border-emerald-600/10 rounded-2xl relative text-right shadow-xl shadow-emerald-900/5">
              ...
              <div className="relative aspect-[16/9] w-full rounded-xl overflow-hidden mb-6 border border-emerald-100 shadow-sm">
                <img
                  src="https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?q=80&w=800"
