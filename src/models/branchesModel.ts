...
export const branchesData: Branch[] = [
  ...
  {
    id: "dubai",
    nameAr: "مكتب دبي (المقر الرئيسي)",
    nameEn: "Dubai Headquarters",
    cityAr: "دبي",
    cityEn: "Dubai",
    countryAr: "الإمارات العربية المتحدة",
    countryEn: "United Arab Emirates",
    phone: "+971 4 2400 5500",
    email: "dubai@aboelseoud-group.com",
    addressAr: "دبي، الإمارات العربية المتحدة",
    addressEn: "Dubai, United Arab Emirates",
    latitude: 32,
    longitude: 60,
    roleAr: "المقر العام لإدارة المجموعة وتنسيق أعمال النقل البحري والأمن الغذائي وتصدير مواد البناء"
  },
  {
    id: "libya",
